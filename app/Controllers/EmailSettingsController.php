...
{
    public function index():void{$settings=EmailSettings::smtp()?:['active'=>0,'host'=>'','port'=>587,'encryption'=>'tls','username'=>'','from_email'=>'','from_name'=>'AstroSport','reply_to'=>''];admin_view('admin/email-settings',['settings'=>$settings,'pageTitle'=>'Correo SMTP','adminSection'=>'email']);}
