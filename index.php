...
foreach([
 ...
 ['GET','/admin/categorias','CategoryController@index'],['POST','/admin/categorias/guardar','CategoryController@save'],['POST','/admin/categorias/eliminar','CategoryController@delete'],
 ['GET','/admin/cta','CtaController@index'],['POST','/admin/cta','CtaController@save'],['GET','/admin/hero','HeroController@index'],['POST','/admin/hero','HeroController@save'],['GET','/admin/flow','FlowSettingsController@index'],['POST','/admin/flow','FlowSettingsController@save'],['GET','/admin/transbank','TransbankSettingsController@index'],['POST','/admin/transbank','TransbankSettingsController@save'],['GET','/admin/correo','EmailSettingsController@index'],['POST','/admin/correo','EmailSettingsController@save'],['GET','/admin/redes-sociales','SocialSettingsController@index'],['POST','/admin/redes-sociales','SocialSettingsController@save']
